...
def main(load=False):
    ...
    print(sample_container['dataloader_test'].dataset.x_sample_test_np)
    print(sample_container['dataloader_test'].dataset.y_sample_test)
    print(type(sample_container['dataloader_test'].dataset.x_sample_test_np))
